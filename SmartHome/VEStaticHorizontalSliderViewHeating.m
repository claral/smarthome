...
@interface VEStaticHorizontalSliderViewHeating ()
...
@implementation VEStaticHorizontalSliderViewHeating
...
//	return self.frame.size.width / [self.items count]*1.25f; //item groesser
    return self.frame.size.width / [self.items count]*0.4; //item groesser
