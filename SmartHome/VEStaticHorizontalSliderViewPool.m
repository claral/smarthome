...
#import "VEStaticHorizontalSliderViewPool.h"

#define padding 7.0f
#define needleRectPadding 3.0f
#define needleStrength 10.0f

@interface VEStaticHorizontalSliderViewPool ()
...
@implementation VEStaticHorizontalSliderViewPool
...
//	return self.frame.size.width / [self.items count]*1.25f; //item groesser
    return self.frame.size.width / [self.items count]*0.3; //item groesser
