...
@interface SHDetailviewBasementLightVC()
...
@implementation SHDetailviewBasementLightVC
...
- (void)viewDidLoad
{
    ...
    navSC.changeHandler = ^(NSUInteger newIndex) {
        ...
        [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentIndexValue] forKey:@"currentIndexValueLightBasement"];
        [[NSUserDefaults standardUserDefaults] synchronize];
        [navSC setIndexToBeginWith:newIndex];
        
        
        // show ON OFF // within light view
        self.currentIndexValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentIndexValueLightBasement"] integerValue];
        int returnIdxVal;
    ...
    self.currentPercentageValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentPercentageValueLightBasement"] floatValue];
...
- (void) viewWillDisappear:(BOOL)animated
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithFloat:_pwvc.percentageWheelView.valueAngle] forKey:@"currentPercentageValueLightBasement"];
