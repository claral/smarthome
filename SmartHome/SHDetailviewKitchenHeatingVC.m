//
//  SHDetailviewKitchenHeatingVC.m
//  SmartHome
//
...
@interface SHDetailviewKitchenHeatingVC ()
...
@implementation SHDetailviewKitchenHeatingVC
...
- (void)viewDidLoad
{
    ...
    self.currentIndex = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentHeatingIndexKitchen"] intValue];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.currentHeatingValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentHeatingValueKitchen"] integerValue];
    // reading stored row
    int currRow = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentRowValueKitchen"] integerValue];
...
- (void)sliderDidMoveTo:(NSInteger)index
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentIndex] forKey:@"currentHeatingIndexKitchen"];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentHeatingValue] forKey:@"currentHeatingValueKitchen"];
    // storage of row
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:row] forKey:@"currentRowValueKitchen"];
}
