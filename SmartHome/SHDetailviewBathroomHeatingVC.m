//
//  SHDetailviewBathroomHeatingVC.m
//  SmartHome
//
...
@interface SHDetailviewBathroomHeatingVC()
...
@implementation SHDetailviewBathroomHeatingVC
...
- (void)viewDidLoad
{
    ...
    self.currentIndex = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentHeatingIndexBathroom"] intValue];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.currentHeatingValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentHeatingValueBathroom"] integerValue];
    // reading stored row
...
- (void)sliderDidMoveTo:(NSInteger)index
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentIndex] forKey:@"currentHeatingIndexBathroom"];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentHeatingValue] forKey:@"currentHeatingValueBathroom"];
    // storage of row
