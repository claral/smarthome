...
@interface VEIFStaticHorizontalSliderViewControllerPool ()

@property (nonatomic, strong) VEStaticHorizontalSliderViewPool *horizontalView;
@property (nonatomic, assign) CGPoint startingPosition;

@end

@implementation VEIFStaticHorizontalSliderViewControllerPool
...
//									 horizontalViewSize.height);
	...
	self.horizontalView = [[VEStaticHorizontalSliderViewPool alloc] initWithFrame:horizontalViewFrame];
