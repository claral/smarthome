...
@interface SHDetailviewBathroomLightVC()
...
@implementation SHDetailviewBathroomLightVC
...
- (void)viewDidLoad
{
    ...
    navSC.changeHandler = ^(NSUInteger newIndex) {
        ...
        [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentIndexValue] forKey:@"currentIndexValueLightBathroom"];
        [[NSUserDefaults standardUserDefaults] synchronize];
        [navSC setIndexToBeginWith:newIndex];
        
        
        // show ON OFF // within light view
        self.currentIndexValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentIndexValueLightBathroom"] integerValue];
        int returnIdxVal;
    ...
    self.currentPercentageValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentPercentageValueLightBathroom"] floatValue];
...
- (void) viewWillDisappear:(BOOL)animated
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithFloat:_pwvc.percentageWheelView.valueAngle] forKey:@"currentPercentageValueLightBathroom"];
