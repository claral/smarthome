//
//  SHDetailviewLivingroomLightVC.m
//  SmartHome
//
...
- (void)viewDidLoad
{
    ...
    navSC.changeHandler = ^(NSUInteger newIndex) {
        ...
        [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithInt:self.currentIndexValue] forKey:@"currentIndexValueLightLivingRoom"];
        [[NSUserDefaults standardUserDefaults] synchronize];
        [navSC setIndexToBeginWith:newIndex];
        
        
        // show ON OFF // within light view
        self.currentIndexValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentIndexValueLightLivingRoom"] integerValue];
        int returnIdxVal;
    ...
    self.currentPercentageValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"currentPercentageValueLightLivingRoom"] floatValue];
...
- (void) viewWillDisappear:(BOOL)animated
{
    ...
    [[NSUserDefaults standardUserDefaults] setValue:[NSNumber numberWithFloat:_pwvc.percentageWheelView.valueAngle] forKey:@"currentPercentageValueLightLivingRoom"];
